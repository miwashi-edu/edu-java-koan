...
public class BasicDataTypesKoan {
    ...
    @Disabled
    @Test(name = "Given an integer, it should match its expected value.")
    ...
    @Disabled
    @Test(name = "Given a double, it should closely match its expected value.")
    ...
    @Disabled
    @Test(name = "A character should match its expected symbol.")
    ...
    @Disabled
    @Test(name = "Booleans express truth values. True or false?")
    ...
    @Disabled
    @Test(name = "A byte has a maximum value of 127. Match it!")
